...
/// Mapas de colores por modo de viaje
const _modoColors = {
...
/// Configuración de cada pregunta Q1-Q4 con UX no clínica
class _Question {
  final String id;
  final String question;
  final List<String> options;  // 4 opciones (valores 1-4)
...
const _questions = [
  _Question(
    id: 'q1',
    question: '¿Cuánta energía mental tienes hoy?',
    options: [
      'Mucha — me siento enfocado/a',
      'Suficiente, aunque cansado/a',
      'Poca, me cuesta concentrarme',
  ...
  _Question(
    id: 'q2',
    question: '¿Sientes tensión en tu cuerpo?',
    options: [
      'Nada, estoy relajado/a',
      'Un poco de tensión',
      'Bastante tensión muscular',
      'Mucha tensión, me duele el cuerpo',
    ],
    icons: [
...
/// Pantalla de evaluación de vitalidad de viaje (Q1-Q4)
/// Nunca muestra terminología clínica. Incluye disclaimer y consentimiento.
...
class _WellnessAssessmentScreenState extends State<WellnessAssessmentScreen>
  ...
  // ── State ──────────────────────────────────────────────────────
  int _step = 0;  // 0=disclaimer, 1-4=preguntas, 5=resultado
  ...
  Widget _buildCurrentStep(ColorScheme scheme) {
    ...
    if (_step >= 1 && _step <= 4) return _buildQuestion(scheme, _step - 1);
    if (_step == 5 && _result != null) return _buildResult(scheme);
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  modoColor.withValues(alpha: 0.15),
                  modoColor.withValues(alpha: 0.05),
                ],
              ),
            ...
            child: Column(
              children: [
                Container(
                  ...
                  height: 64,
                  decoration: BoxDecoration(
                    color: modoColor.withValues(alpha: 0.15),
                    shape: BoxShape.circle,
                  ),
                ...
                Text(
                  modoDesc.isNotEmpty ? modoDesc : result.modoViajeDescription,
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14,
                    height: 1.5,
                ...
                child: Column(
                  children: [
                    if (_feedbackSent)
                      ...
                      Text(
                        '¿Estas recomendaciones se sienten adecuadas para ti?',
                        style: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w500,
                          color: scheme.onSurface.withValues(alpha: 0.7),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'Encontrando tus lugares ideales…',
            style: TextStyle(
              fontSize: 14,
              color: scheme.onSurface.withValues(alpha: 0.55),
            ),
